  ...
  return (
    <section className="py-20 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {metrics.map((metric, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-700 p-8 rounded-3xl border border-slate-200 dark:border-slate-600 hover:border-teal-300 dark:hover:border-teal-400 transition-all duration-300 hover:shadow-lg hover:shadow-teal-100 dark:hover:shadow-teal-500/20 text-center h-full">
                <motion.div
                ...
                >
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">Progress toward target</p>
                </motion.div>
              </div>
            </motion.div>
          ))}
        ...
        >
          <div className="bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20 p-8 rounded-2xl border border-teal-200 dark:border-teal-500/30 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
              {['Engagement Rate', 'Retention Rate', 'Quality Score', 'Impact Score'].map((label, i) => (
                <div key={i} className="text-center">
                  <div className="text-2xl text-teal-600 dark:text-teal-400 mb-1">{85 + i * 2}%</div>
